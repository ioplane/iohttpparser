...
graph TD
    ...
    A13["13 Версионирование И Журнал Изменений"]
    API["Справочник API"]
...
| 13 | [Версионирование И Журнал Изменений](./13-versioning-and-changelog.md) | Идентификаторы версий, политика релизных кандидатов и правила для `CHANGELOG.md` |
