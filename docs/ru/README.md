...
- [`parser-state.md`](parser-state.md) с описанием публичного stateful parser API
- [`codex-tuning-plan.md`](codex-tuning-plan.md) с шаблоном тюнинга Codex и прикладным планом для `iohttpparser`
