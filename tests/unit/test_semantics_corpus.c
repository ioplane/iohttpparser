...
void test_semantics_corpus_cases(void)
{
    static const char *cases[] = {
        ...
        IHTP_SOURCE_DIR "/tests/corpus/semantics/response_no_body_101_ignores_te.case",
        IHTP_SOURCE_DIR "/tests/corpus/semantics/response_no_body_101_rejects_te_cl.case",
        IHTP_SOURCE_DIR "/tests/corpus/semantics/response_no_body_204_rejects_te_cl.case",
        ...
        IHTP_SOURCE_DIR "/tests/corpus/semantics/response_no_body_304_rejects_te_cl.case",
